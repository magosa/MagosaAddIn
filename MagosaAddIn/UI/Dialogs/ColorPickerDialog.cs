...
namespace MagosaAddIn.UI.Dialogs
{
    ...
    public partial class ColorPickerDialog : BaseDialog
    {
        ...
        #region 内部クラス: GradientBar

        /// <summary>
        /// グラデーション描画付きのスライダーコントロール。
        /// DrawGradient デリゲートに実際の描画ロジックを注入する。
        /// </summary>
        private class GradientBar : Control
        {
            ...
            /// <summary>グラデーション描画デリゲート。null なら無地表示。</summary>
