...
PowerPointでの図形操作を効率化するVSTOアドインです。図形の整列・分割・配置・選択補助・ハンドル調整・レイヤー管理・ナンバリング・置き換え・サイズ調整・配列複製・テーマカラー生成・テキスト一括編集・スタイルライブラリ・**画像倍率同期**機能を提供します。
